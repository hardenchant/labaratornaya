...
touch file_name							- создаёт файл с названием file_name (далее предлагается ввести содержимое файла)
...
open file_name							- открыть файл file_name (требует закрытия после использования "close")
tree									- выводит текущую директорию в виде дерева с содержанием "всего"
readonly file_name/dir_name				- ставит метку readonly на файл\директорию (запрет копирования и удаления)
